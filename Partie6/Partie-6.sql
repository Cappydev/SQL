-- 'SQL - Sélection de données - Élargir les possibilités de la clause WHERE'

-- Chargement du fichier ajout.sql dans la base de donnée webDevelopment
SOURCE /home/cote/Documents/Back-end/SQL/Partie6/ajout.sql;
